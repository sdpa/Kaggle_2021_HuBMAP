...
classes = ['Sky', 'Building', 'Column-Pole', 'Road',
           'Sidewalk', 'Tree', 'Sign-Symbol', 'Fence', 'Car', 'Pedestrian',
           'Bicyclist', 'Void']
...
cam_class_weight = [0.58872014284134, 0.51052379608154, 2.6966278553009, 0.45021694898605, 1.1785038709641,
                0.77028578519821, 2.4782588481903, 2.5273461341858, 1.0122526884079, 3.2375309467316,
                4.1312313079834, 0]
# mean and std
cam_mean = [0.41189489566336, 0.4251328133025, 0.4326707089857]
cam_std = [0.27413549931506, 0.28506257482912, 0.28284674400252]
...
class CamVid(data.Dataset):
    ...
    def __init__(self, root, split='train', joint_transform=None,
                 transform=None, target_transform=LabelToLongTensor(), target_plot=Cam_LabelTensorToPILImage(), loader=default_loader):
        self.root = root
        ...
        self.loader = loader
        self.class_weight = cam_class_weight
