...
tmp = torch.randn((2, 3, 64, 64)).to(device)
augmented_conv1 = AugmentedConv(in_channels=3, out_channels=20, kernel_size=3, dk=4, dv=10, Nh=1, relative=False, stride=2).to(device)
...
# augmented_conv2 = AugmentedConv(in_channels=3, out_channels=20, kernel_size=3, dk=2, dv=4, Nh=2, relative=False, stride=1).to(device)
