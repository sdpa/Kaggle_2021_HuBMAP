...
class UCaps22(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=False):
        super(UCaps22, self).__init__()
        ...
        # Up ops
        self.upcaps_1 = UCapsuleLayer(16, 32, "deconv", k=3, s=2, t_1=8, z_1=32, routing=3, padding=1)
        self.upconv_1 = UDenseBlock(512, 128, 2, upsample=True)
        self.upcaps_2 = UCapsuleLayer(8, 32, "deconv", k=3, s=2, t_1=8, z_1=16, routing=3, padding=1)
        self.upconv_2 = UDenseBlock(256, 64, 2, upsample=True)
        self.upcaps_3 = UCapsuleLayer(8, 16, "deconv", k=3, s=2, t_1=4, z_1=16, routing=3, padding=1)
        self.upconv_3 = UDenseBlock(128, 32, 2, upsample=True)
    ...
    def forward(self, x):
        ...
        x1c = x1c.reshape(
            [x1c.shape[0], 4, 16, x1c.shape[3], x1c.shape[4]])  # [batch size, caps, features per cap, H, W]
        x2 = self.caps1(x1c)
